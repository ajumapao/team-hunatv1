...
function add_login_link(){
    ...
    if(!empty($cu_lginurl)){
          $newitems = '<li><a class="mylllmenu" title="Logout" href="'.$cu_lginurl.'">LOGIN/REGISTER</a></li>';
          return $newitems;  
        }else{
           $newitems = '<li><a class="mylllmenu" title="Login" href="'.wp_login_url($myloginid) .'">LOGIN/REGISTER</a></li>'; 
           return $newitems;
        }
} 
